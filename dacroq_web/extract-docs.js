...
// Copy the DocsContent object here
const DocsContent = {
  introduction: {
    title: "Introduction",
...
// Get description based on section ID
const getDescription = (id) => {
  switch(id) {
    case "introduction": return "Platform overview and features";
    case "quick-start": return "Get started with Dacroq quickly";
    case "installation": return "Setup and access instructions";
    case "3-sat-solver": return "Our primary Boolean satisfiability solver";
    case "k-sat-solver": return "Variable clause length SAT solver (Coming Soon)";
    case "ldpc-solver": return "Low-Density Parity-Check solver (Coming Soon)";
    default: return "";
  }
};
...
const getIcon = (id) => {
  switch(id) {
    case "introduction": return "file-text";
    case "quick-start": return "book-open";
    case "installation": return "download";
    case "3-sat-solver": retur