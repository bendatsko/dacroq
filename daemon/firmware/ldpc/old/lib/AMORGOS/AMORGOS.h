    ...
    */
    ...
    class AMORGOS
    {
        ...
        private:
            ...
            // SPI Settings - try slower speed first
            uint32_t AMORGOS_SPI_CLK = 1000000;    // 1MHz instead of 20MHz
            uint8_t AMORGOS_SPI_DIV = 0;            // SPI clock divider (2^DIV division)

            SPISettings AMORGOS_SPI_Settings = SPISettings(AMORGOS_SPI_CLK, MSBFIRST, SPI_MODE0);
    };
