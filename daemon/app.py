...
allowed_origins_env = os.getenv('ALLOWED_ORIGINS', 'http://localhost:3000,https://dacroq.eecs.umich.edu,https://dacroq-api.bendatsko.com,https://release.bendatsko.com,https://dacroq.net,https://www.dacroq.net,https://api.dacroq.net')
