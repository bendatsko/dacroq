...
import { RiCloseLine, RiDeleteBinLine, RiFileLine, RiFileListLine, RiCheckLine, RiCloseFill } from "@remixicon/react";
...
type SolverType = 'walksat' | 'minisat' | 'hardware';
...
const CreateTestWindow: React.FC<CreateTestWindowProps> = ({ isOpen, onClose, onTestComplete }) => {
    ...
    const [selectedSolver, setSelectedSolver] = useState<SolverType>('hardware');
    ...
    const removeFile = (fileName: string) => {
        ...
        // Update uploaded types after removal
        const types: UploadedFileTypes = { cnf: false };
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            try {
                ...
                const newTest = {
                    name: `${selectedSolver.toUpperCase()} Benchmark`,
                    status: "completed",
                ...
                <div className="p-6">
                    <Card className="p-4 mb-4">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                            Upload your CNF problem files (individually or in a ZIP archive) and select a solver.
                            The tool will run the selected solver on your problems and generate benchmark results.
                        </p>
                        ...
                        <div className="mt-4">
                            <label className="block text-sm font-medium mb-2">Select Solver</label>
                            <Select value={selectedSolver} onValueChange={(value) => setSelectedSolver(value as SolverType)}>
                                <SelectTrigger>
                                    {selectedSolver.toUpperCase()}
                                </SelectTrigger>
                                <SelectContent>
                                    <SelectItem value="walksat">WalkSAT</SelectItem>
                                    <SelectItem value="minisat">MiniSAT</SelectItem>
