    ...
    const submitToApi = async (testName: string, chipType: string) => {
        try {
            ...
            const payload = {
                ...
                solver_type: "hybrid", // Default to hybrid solver
                enable_hardware: true, // Enable hardware acceleration
                hardware_threshold: 10, // Default threshold of 10 unsatisfied clauses
                max_hardware_time: 10000, // 10ms default
                            ...
                            <div className="border-t border-gray-200 dark:border-gray-700 p-6 flex justify-between">
                                ...
                                <div className="flex gap-3">
                                    <Button
                                        type="button"
                                        variant="outline"
                                        onClick={() => generateBatchJson()}
                                        disabled={isSubmitting}
                                        className="text-gray-700 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-200 border-gray-300 dark:border-gray-600"
                                    >
                                        Generate JSON
                                    </Button>
                                    <Button
                                    ...
                                    >
                                        {isSubmitting ? "Running..." : "Apply and Process"}
                                    </Button>
                                </div>
                            </div>
                        </form>
